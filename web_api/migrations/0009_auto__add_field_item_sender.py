...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.sender'
        db.add_column(u'web_api_item', 'sender',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.sender'
        db.delete_column(u'web_api_item', 'sender')
    ...
    models = {
        ...
        u'web_api.item': {
            ...
            'sender': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),
