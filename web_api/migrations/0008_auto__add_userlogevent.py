...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserLogEvent'
        db.create_table(u'web_api_userlogevent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('client', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('event', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('detail', self.gf('django.db.models.fields.CharField')(max_length=1024)),
        ))
        db.send_create_signal(u'web_api', ['UserLogEvent'])


    def backwards(self, orm):
        # Deleting model 'UserLogEvent'
        db.delete_table(u'web_api_userlogevent')
    ...
    models = {
        ...
        u'web_api.userlogevent': {
            'Meta': {'object_name': 'UserLogEvent'},
            'client': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
            'detail': ('django.db.models.fields.CharField', [], {'max_length': '1024'}),
